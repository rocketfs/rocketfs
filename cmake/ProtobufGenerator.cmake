...
foreach(FBS_FILE ${FBS_FILES})
  ...
  add_custom_command(
    ...
    COMMAND flatbuffers::flatc --cpp --gen-object-api -o ${CMAKE_BINARY_DIR}/generated
            ${FBS_FILE}
    DEPENDS ${FBS_FILE}
    COMMENT "Generating flatbuffer headers for ${FBS_NAME}"
  )
  list(APPEND GENERATED_FBS_HEADERS ${CMAKE_BINARY_DIR}/generated/${FBS_NAME}_generated.h)
endforeach()
